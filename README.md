...
本项目基于 MIT 协议开源，使用者可自由查看、修改、分发本项目代码，但请知悉以下条款：

- **使用风险自担**：本软件按"原样"提供。使用本软件所引发的任何风险（数据丢失、设备损坏、网络问题等）均由使用者自行承担。
- **合法合规使用**：请在符合所在国家/地区法律法规的前提下使用本软件，不得用于任何违法用途（包括但不限于非法传输受版权保护的内容、传播恶意文件等）。因违规使用导致的一切后果由使用者自行承担。
- **数据与隐私**：本软件仅在局域网内通信。请使用者妥善保管自己的聊天记录与传输文件，避免泄露敏感信息。
- **非商业承诺**：本项目为个人/学习交流项目，作者不承诺持续维护、更新或提供技术支持。

如不同意以上条款，请勿使用本软件。一旦下载、安装或使用本软件，即视为已阅读、理解并同意上述免责声明。
